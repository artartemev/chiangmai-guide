...
COLLECTIONS = [
    {
        ...
        "description": "Парки, водные аттракционы, кафе с животными и педиатры — самая частая тема вопросов в чате.",
        "cover": 418,
        "items": [
            ...
            (313, "Зоопарк с пандами и аквариумом, лучше с утра."),
            (302, "Ботанический сад Tweechol — велосипеды, животные, много тени."),
            (97, "Ma Plearn — семейное wellness-пространство с занятиями для детей."),
            (296, "Небольшой водопад у озера Хуай Тынг Тао — можно плескаться."),
            (403, "Кафе с кошками."),
            (489, "Кафе у реки со слонами и собаками."),
            (197, "Настольные игры и чистый воздух в сезон дыма."),
            (221, "Педиатр, которого рекомендуют в чате."),
            (232, "Ещё один педиатр с высокой оценкой."),
        ],
    },
    {
