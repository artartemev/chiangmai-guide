...
ENSURE_PLACES = [
    {
        ...
        "veg_friendly": 1,
        "description": "Тёплое комьюнити-пространство и чайный клуб в районе Chang Khlan, где рождается этот гид. Уютное место для встреч, душевного общения и культурных событий: чайные церемонии с коллекционными улунами и пуэрами, киртаны и медитации, киновечера, квизы, настольные игры, йога-нидра, воркшопы — почти каждый вечер что-то происходит, расписание в Афише.",
        "community_summary": {
            "highlights": ["Главное комьюнити-пространство русскоязычного Чиангмая: 15+ регулярных событий в каталоге", "Чайная культура: дегустации высокогорных улунов и пуэров"],
            "pricing": ["Большинство вечеров — по донату или 200–400 THB"],
            "tips": ["Анонсы — в Telegram @omhome_thai и в Афише; на популярные вечера лучше писать заранее", "Продать или купить что-то в Таиланде — барахолка NaviTo: navito.omhome.space"],
        },
    },
]
